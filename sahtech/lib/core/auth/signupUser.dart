...
class _SignupUserState extends State<SignupUser> {
  ...
  Future<void> _handleSignup() async {
    ...
    widget.userData.name = "${_prenomController.text.trim()} ${_nomController.text.trim()}";
    ...
    try {
      ...
      final registrationResult = await authService.registerUser(widget.userData);
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                            color: _nomError != null ? Colors.red : Colors.transparent,
                                            width: 1.5,
                                          ),
                                        ),
                                        child: TextFormField(
                                      ...
                                      SizedBox(height: _nomError != null ? 8.h : 16.h),
                                      ...
                                      SizedBox(height: _emailError != null ? 8.h : 16.h),
                                      ...
                                      SizedBox(height: _passwordError != null ? 8.h : 16.h),
                                      ...
                                      SizedBox(height: _confirmPasswordError != null ? 8.h : 24.h),
