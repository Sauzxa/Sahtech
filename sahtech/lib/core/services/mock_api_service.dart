...
class MockApiService {
  ...
  // Control parameters
  final bool _shouldSimulateErrors = false; // Set to true to test error handling
  ...
  ProductModel _generateRandomProduct(String barcode) {
    ...
    final categories = ['Produits laitiers', 'Boulangerie', 'Boissons', 'Snacks', 'Fruits et légumes'];
    final brands = ['Nature Bio', 'Délices Frais', 'Saveurs Authentiques', 'Bon Appétit', 'Frutti Fresh'];
  ...
  static List<AdModel> _getMockAds() {
    return [
      AdModel(
        ...
        description: 'Un médicament naturel pour soulager les douleurs articulaires',
