...
class _ProductRecommendationScreenState extends State<ProductRecommendationScreen> {
  ...
  void initState() {
    ...
    recommendation = "Attention ! Le fromage frais de Soummam contient des ingrédients susceptibles de déclencher une réaction allergique en raison de votre sensibilité déclarée. Pour une alternative plus adaptée à votre régime, nous vous recommandons d'opter pour Soummam Tartifast, qui est exempt des allergènes concernés et plus sûr pour votre consommation.";
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        CircleAvatar(
                          radius: 10.r,
                          backgroundColor: _getNutriScoreColor(widget.product.healthScore),
                          child: Text(
