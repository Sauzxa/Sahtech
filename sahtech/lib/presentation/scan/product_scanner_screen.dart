  ...
  Future<void> _pickImageFromGallery() async {
    try {
      ...
      if (image != null) {
        ...
        if (result != null && result.barcodes.isNotEmpty && result.barcodes.first.rawValue != null) {
                              ...
                              Flexible(
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: !_isQrMode ? AppColors.lightTeal : Colors.transparent,
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 11.sp,
                                        fontWeight: FontWeight.w600,
                                        color: !_isQrMode ? Colors.black87 : Colors.black54,
                                      ),
                                    ),
                                  ),
                                ),
                            ...
                            builder: (context, child) {
                              return Positioned(
                                top: _isQrMode
                                    ...
                                    : MediaQuery.of(context).size.height * 0.25 * _animation.value,
                                left: 0,
                                right: 0,
                                child: Container(
                                  height: 3.h,
