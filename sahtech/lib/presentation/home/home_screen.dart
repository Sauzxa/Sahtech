  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (widget.userData.userId != null) {
        final products = await _apiService.getUserProducts(widget.userData.userId!);
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Color(0x4D9FE870), // 9FE870 with 30% opacity
                            ...
                            child: Row(
                              ...
                              children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(
                                          fontSize: 18.sp,
                                          color: Color(0xFF82A6B0), // 82A6B0 color
                                        ),
                                      ),
                                    ],
                                  ),
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Color(0xB39FE870), // 9FE870 with 70% opacity
                      ...
                      SizedBox(
                        height: 125.h, // Slightly increased height to prevent overflow
                                  ...
                                  return Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              ...
                                              width: 80.w,
                                              height: 98.h, // Slightly reduced height
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          child: Padding(
                                            padding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 8.h), // Reduced vertical padding
                                            child: Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                // Rating
                      ...
                      SizedBox(height: 70.h), // Extra space for bottom navigation bar
                    ],
                  ),
                ),
              ),
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildNavScanItem(),
                _buildNavItem(3, Icons.contacts_outlined, Icons.contacts, 'Contacts'),
