...
class _Profile8State extends State<Profile8> {
  ...
  Map<String, String> _translations = {
    ...
    'subtitle': 'Choisissez votre date de naissance pour mieux adapter votre expérience.',
    'year': 'Year',
    'month': 'Month',
    'day': 'Day',
    'next': 'suivant',
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: CupertinoPicker(
                                          ...
                                          scrollController: FixedExtentScrollController(
                                              initialItem: _years.indexOf('2021')),
                                          itemExtent: 44.h,
                                          diameterRatio: 1.2,
                                      ...
                                      Expanded(
                                        child: CupertinoPicker(
                                          backgroundColor: Colors.transparent,
                                          scrollController: FixedExtentScrollController(
                                              initialItem: _months.indexOf('Avr')),
                                          itemExtent: 44.h,
                                          diameterRatio: 1.2,
                                          selectionOverlay: const CupertinoPickerDefaultSelectionOverlay(
                                            background: Colors.transparent,
