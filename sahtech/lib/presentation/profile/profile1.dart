  ...
  class _Profile1State extends State<Profile1> with WidgetsBindingObserver {
    ...
    void didChangeDependencies() {
      ...
      if (_currentLanguage != translationService.currentLanguageCode) {
        debugPrint("Language changed from $_currentLanguage to ${translationService.currentLanguageCode}");
    ...
    Future<void> _loadTranslations() async {
      ...
      try {
        ...
        if (_currentLanguage != 'fr') {
          ...
          final translated = await _translationService.translateMap(_translations);
