...
class _Profile4State extends State<Profile4> {
  ...
  void _continueToNextScreen() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(builder: (context) => Profile5(userData: widget.userData)),
    );
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FutureBuilder<String>(
                              future: _translationService.translate('Pratiquez-vous une activité physique ?'),
                              builder: (context, snapshot) {
                                final text = snapshot.data ?? 'Pratiquez-vous une activité physique ?';
                                return Text(
                                  text,
                                  style: TextStyle(
                                    fontSize: 24.sp,
