...
class _Nutritioniste1State extends State<Nutritioniste1> {
  ...
  late TranslationHelper _translationHelper;
  ...
  void initState() {
    ...
    _translationHelper = TranslationHelper(context, _translations);
  ...
  Future<void> _loadTranslations() async {
    ...
    try {
      // Use the translation helper to translate all strings
      final translatedStrings = await _translationHelper.translateAll();
  ...
  void _continueToNextScreen() {
    if (_formKey.currentState!.validate()) {
      ...
      // Navigate to the next screen without showing success message
      // Success message will only be shown at final submission
      Navigator.push(
        context,
        MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    ...
    final textDirection = _translationService.getTextDirection();

    return Directionality(
      // Apply the correct text direction based on the selected language
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              textDirection: TextDirection.ltr, // Always LTR for name input
